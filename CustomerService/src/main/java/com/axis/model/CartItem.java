...
public class CartItem {
	...
	public CartItem(String productId, String productName, int sellingPrice, int costPrice, Set<String> imageUrls1,
			int quantities) {
		super();
		this.productId = productId;
	...
	public String toString() {
		return "CartItem [productId=" + productId + ", productName=" + productName + ", sellingPrice=" + sellingPrice
